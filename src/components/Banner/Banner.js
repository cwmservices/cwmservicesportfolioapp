          ...
          <div className="banner-details">
            <div className="col">
              <div className="col-icon">
                <a
                  target="_blank"
                  href="https://www.facebook.com/official.codewithmasood"
                >
                ...
                <a target="_blank" href="https://www.twitter.com/official_cwm">
            ...
            <div className="banner-details-name">
              <span className="banner-text">
                {" "}
                Hello, My Name is{" "}
                <span className="highlighted-text">Masood</span>
              </span>
            </div>
            ...
            <div className="banner-options">
              <a target="_blank" href="https://www.fiverr.com/cwmservices">
